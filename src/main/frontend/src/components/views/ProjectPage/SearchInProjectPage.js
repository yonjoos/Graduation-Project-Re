...
// 프로젝트 페이지에서 검색어 입력과 엔터 및 클릭 버튼을 위임받은 하위 검색 컴포넌트
function SearchInProjectPage({ onSearch, onChange }) {

    const [localSearchTerm, setLocalSearchTerm] = useState("");
    // 독자적인 자기 자신의 검색어 입력 필드 값 가지고 세팅. 
    ...
    return (
        <Col span={24} style={{ textAlign: 'center' }}>
            <Search
                placeholder="프로젝트 관련 키워드를 검색해보세요!"
...
export default SearchInProjectPage;
